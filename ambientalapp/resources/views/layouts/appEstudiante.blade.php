      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item @yield('menuInsignia')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../layout/top-nav.html" class="nav-link @yield('contenidoInsignia')">
                  <ion-icon name="trophy"></ion-icon>
                  <p>Insignias contenido</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../layout/top-nav-sidebar.html" class="nav-link @yield('grupoInsignia')">
                  <ion-icon name="trophy"></ion-icon>
                  <p>Insignias grupo</p>
                </a>
              </li>
