...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Bienvenid@ {{auth()->user()->nombre}}</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Visitas online</h3>
              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-row justify-content-end">
                  ...
                  <span>
                    <i class="fas fa-square text-gray"></i> Ultima semana
                  </span>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Vistas de escuelas</h3>
                  <a href="javascript:void(0);">Ver reporte</a>
                </div>
              </div>
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg">23,500</span>
                    <span>Visitas a través del tiempo</span>
                  </p>
                  <p class="ml-auto d-flex flex-column text-right">
                    <span class="text-success">
